...
- [x] Existing PNG caches work before any migration.
- [x] Catalog rebuild indexes the existing cache without moving or rewriting frames.
- [x] Compression migration is dry-run-first, restartable, and verifies every converted file before optional source deletion.
